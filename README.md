...
Skills about *how to work* — planning, domain modelling, and method. Derived from [Matt Pocock's skills](https://github.com/mattpocock/skills) (MIT), adapted to emit Emacs Org-mode files.
